...
def create_lw_config_cross_account_access_role(lw_account_name, external_id):
    logger.info("aws.create_lw_config_cross_account_access_role.")
    iam = boto3.client("iam")

    try:

        lacework_cws_policy = json.dumps({
            "Version": "2012-10-17",
            "Statement": [
                {
        ...
        create_policy_response = iam.create_policy(
            ...
            PolicyDocument=lacework_cws_policy
        )
        ...
        logger.error("Create cross account role error: {}.".format(e))
        return None


def delete_lw_config_cross_account_access_role(lw_account_name, aws_account_id):
    logger.info("aws.delete_lw_config_cross_account_access_role.")
    iam = boto3.client("iam")
    ...
    try:
        ...
        logger.error("Delete cross account role error: {}.".format(e))
        return False
